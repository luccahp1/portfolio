...
- v1.5 also:
  - **`race`** terminal command: scrolls to top, locks scrolling (html overflow + wheel/touch/key blockers), shows a full-width 400px semi-transparent checkered banner, counts 3-2-1-GO with blips, then unlocks and restarts the speedrun clock (`rearmSpeedrun`).
