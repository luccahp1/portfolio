...
- Small acknowledgments (each once, politely): copy/select-all/idle toasts, a speedrun footer ending with your official time and paper-scrap confetti (trackpad scrollers get a fairer window), seasonal margin notes, an "eavestroughs" hover tooltip, a "prada" hover tooltip that has heard your handbag joke already, steam that rises off the coffee note when you hover it, escalating Konami snark, three pencil inks (`c`), a favicon that naps when you leave the tab, and a birthday greeting on July 2.
